...
SERVER_OBJS := $(SERVER_SRCS:.c=.o) $(C_SRCS:.c=.o) $(DUPSOCK_SRCS:.c=.o) $(UDPS_SRCS:.c=.o) $(CCQUEUE_SRCS:.c=.o) $(OPOOL_SRCS:.c=.o) 
SERVER_OBJS += $(DICOM_PROTO_OBJS)

CLIENT_OBJS := $(CLIENT_SRCS:.c=.o) $(C_SRCS:.c=.o)
